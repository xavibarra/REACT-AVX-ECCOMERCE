  ...
  return (
    <section className="ab-container">
      <div className="ab-description-container">
        ...
        <p className="ab-description">
        At Components Portions, we believe in the power of technology to transform
        lives. Our mission is to offer premium products at competitive prices, combined
        with exceptional customer service. Our knowledgeable team is here to guide you
        through every step of your purchase, ensuring you find the perfect components
        to meet your specific needs.
        </p>
        <p className="ab-description">
        Thank you for choosing Components Portions. We are committed to making your
